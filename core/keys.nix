...

{
  config = {
    sops.secrets."weatherapi.com" = {
      # How to abstract away username? Maybe requires sops-nix in home-manager.
      owner = "kiran";
      group = "kiran";
    };
  };
  ...
  options = {
    pgp_enc = lib.mkOption {
      default = "5B2FC8FC2BCF1A58885D6C92B67BBEB336616007";
      type = with lib.types; uniq str;
      description = "Enc key (on yubikey)";
    };
    pgp_sign = lib.mkOption {
      default = "8BC774E4A2EC75073B61A6470BBB1C8B1C3639EE";
      type = with lib.types; uniq str;
      description = "Sign key (on yubikey)";
    };
    pgp_auth_ssh = lib.mkOption {
      default = "ssh-rsa  cardno:23_350_388";
      type = with lib.types; uniq str;
      description = "Auth key converted to ssh";
    };
    pgp_auth_2_ssh = lib.mkOption {
