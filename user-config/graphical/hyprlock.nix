{
  home-manager.users.kiran = { osConfig, lib, ... }:
    let
      scaleArray = array:
    ...
    in {
      services.hypridle = {
        ...
        settings = {
          general = {
            lock_cmd =
              "pidof hyprlock || { hyprlock && eww open bar; }"; # avoid starting multiple hyprlock instances.
      ...
      programs.hyprlock = {
        ...
        settings = {
          ...
          input-field = {
            ...
            fade_on_empty = true;
            fade_timeout =
              1000; # Milliseconds before fade_on_empty is triggered.
            placeholder_text =
